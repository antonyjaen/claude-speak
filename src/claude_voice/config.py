"""File-backed runtime config at ``~/.claude-voice/config.json``.
...
SCHEMA: dict[str, tuple[str, Any, Optional[type]]] = {
    "focus_pattern":  ("CLAUDE_VOICE_FOCUS_PATTERN",  "", str),
    "hotkey":         ("CLAUDE_VOICE_HOTKEY",         "f9", str),
    "auto_submit":    ("CLAUDE_VOICE_AUTO_SUBMIT",    False, bool),
    "rms_threshold":  ("CLAUDE_VOICE_RMS_THRESHOLD",  0.012, float),
    "model":          ("CLAUDE_VOICE_MODEL",          "base", str),
    "lang":           ("CLAUDE_VOICE_LANG",           "auto", str),
    "backend":        ("CLAUDE_VOICE_BACKEND",        "edge", str),
    "voice":          ("CLAUDE_VOICE_VOICE",          "", str),
    "voice_en":       ("CLAUDE_VOICE_VOICE_EN",       "en-US-AriaNeural", str),
    "voice_es":       ("CLAUDE_VOICE_VOICE_ES",       "es-MX-DaliaNeural", str),
    "rate":           ("CLAUDE_VOICE_RATE",           0, int),
    "max_chars":      ("CLAUDE_VOICE_MAX_CHARS",      1200, int),
    "wake_word":      ("CLAUDE_VOICE_WAKE_WORD",      "claude", str),
    "speaker_only":   ("CLAUDE_VOICE_SPEAKER_ONLY",   False, bool),
    "speak_mode":     ("CLAUDE_VOICE_SPEAK_MODE",     "end", str),
}
